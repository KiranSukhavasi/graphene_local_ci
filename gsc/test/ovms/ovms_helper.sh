...
gramine-sgx-pf-crypt encrypt -w Examples/pytorch/base_image_helper/encryption_key -i models -o /mnt/tmpfs/model_encrypted/
docker build --tag ovms-image --file Examples/ovms/ovms-gsc.dockerfile Examples/ovms/
